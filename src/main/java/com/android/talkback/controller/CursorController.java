...
public interface CursorController {
    ...
    /**
     * Used for navigation within an HTML table
     * Attempts to move to the cell in the same column and previous row.
     *
     * @param useInputFocusAsPivotIfEmpty Whether navigation should start from node that has input
     *                                    focused editable node if there is no node with
     *                                    accessibility focus
     ...
     * @return {@code true} if successful.
     */
    boolean upHTML(boolean useInputFocusAsPivotIfEmpty, int inputMode);

    /**
     * Used for navigation within an HTML table
     * Attempts to move to the cell in the same column and next row.
     *
     * @param useInputFocusAsPivotIfEmpty Whether navigation should start from node that has input
     *                                    focused editable node if there is no node with
     *                                    accessibility focus
     ...
     * @return {@code true} if successful.
     */
    boolean downHTML(boolean useInputFocusAsPivotIfEmpty, int inputMode);
